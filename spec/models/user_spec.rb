...
describe "A user" do
  ...
  it "requires a unique, case-sensitive email" do
  ...
  it "requires the password to match the password confirmation" do
    user = User.new(password: "secret", password_confirmation: "secret2")
  ...
  context "when authenticating" do
    ...
    it "returns a non-true value if the email is not valid" do
      expect(User.authenticate("wrong@email.com", @user.password)).not_to eq(true)
    end

    it "returns a non-true value if the password is not valid" do
